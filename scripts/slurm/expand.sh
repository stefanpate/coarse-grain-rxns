...
starters=after_2015_cpds_w_metacyc_coreactants
generations=1
explicit_h=true
...
python $script starters=$starters generations=$generations processes=$processes rules=${rules_sweep[$SLURM_ARRAY_TASK_ID]} explicit_h=$explicit_h enforce_atom_balance=$enforce_atom_balance block_inorganic=$block_inorganic
