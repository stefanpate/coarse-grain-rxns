...
processes=2 # Make sure this matches -n above
exp_sweep=(
...
python $script mapped_rxns=${mappings_sweep[$SLURM_ARRAY_TASK_ID]} expansion=${exp_sweep[$SLURM_ARRAY_TASK_ID]} processes=$